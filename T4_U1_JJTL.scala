...
val data = sc.textFile("/datasets/wiki-clickstream/part-00007-tid-6032324127448382114-25475c12-e29d-46fb-8ee3-7429b3b56efc-29-1-c000.snappy.parquet") //creamos un RDD
...
val clickstream = sqlContext.read.parquet("/datasets/wiki-clickstream/part-00007-tid-6032324127448382114-25475c12-e29d-46fb-8ee3-7429b3b56efc-29-1-c000.snappy.parquet")
...
// MAGIC                              WHERE 
// MAGIC                                    prev_title IN ('','Lady_Gaga') AND
...
// MAGIC 
// MAGIC // Vemos que no se conectan
